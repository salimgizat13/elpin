...
public class DocksBatchAction13 implements Actions {

    public final String action;
    public DocksBatchAction13(String actions) {
        this.action = actions;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Информация из официального сайта Федеральной налоговой службы nalog.ru об имеющимся у Должника имуществе";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupA() {
        ...
        keyboardRow.add(new KeyboardButton("Нет такого документа (перейти к следующему 14/16)"));
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Прикрепить следующий документ 14/16"));
