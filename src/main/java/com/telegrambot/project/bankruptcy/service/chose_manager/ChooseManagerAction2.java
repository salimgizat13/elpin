...
public class ChooseManagerAction2 implements Actions {

    public final String action;
    public ChooseManagerAction2(String action) {
        this.action = action;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Какая у Вас общая сумма задолженности?";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Перейти к следующему вопросу 3/6"));
