...
public class DocksBatchAction14 implements Actions {

    public final String action;
    public DocksBatchAction14(String actions) {
        this.action = actions;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Информация из официального сайта Федеральной налоговой службы nalog.ru подтверждающая наличие у гражданина налоговой задолженности";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupA() {
        ...
        keyboardRow.add(new KeyboardButton("Нет такого документа (перейти к следующему 15/16)"));
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Прикрепить следующий документ 15/16"));
