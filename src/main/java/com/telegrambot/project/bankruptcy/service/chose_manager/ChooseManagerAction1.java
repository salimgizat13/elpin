...
public class ChooseManagerAction1 implements Actions {

    public final String action;
    public ChooseManagerAction1(String action) {
        this.action = action;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Укажите регион вашей регистрации";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Перейти к следующему вопросу 2/6"));
