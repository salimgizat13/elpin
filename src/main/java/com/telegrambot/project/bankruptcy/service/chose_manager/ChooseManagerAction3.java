...
public class ChooseManagerAction3 implements Actions {

    public final String action;
    public ChooseManagerAction3(String action) {
        this.action = action;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Ваш трудовой статус";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Перейти к следующему вопросу 4/6"));
