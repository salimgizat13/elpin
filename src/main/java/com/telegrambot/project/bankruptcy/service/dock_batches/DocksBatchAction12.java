...
public class DocksBatchAction12 implements Actions {

    public final String action;
    public DocksBatchAction12(String actions) {
        this.action = actions;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Информация из официального сайта Федеральной налоговой службы nalog.ru подтверждающая отсутствие сведений об организациях, в которых Должник является руководителем или учредителем ";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupA() {
        ...
        keyboardRow.add(new KeyboardButton("Нет такого документа (перейти к следующему 13/16)"));
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Прикрепить следующий документ 13/16"));
