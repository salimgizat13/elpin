...
public class ChooseManagerAction5 implements Actions {

    public final String action;
    public ChooseManagerAction5(String action) {
        this.action = action;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Есть ли у вас движимое имущество?";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Перейти к следующему вопросу 6/6"));
