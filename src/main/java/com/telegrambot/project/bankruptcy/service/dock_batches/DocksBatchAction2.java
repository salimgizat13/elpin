...
public class DocksBatchAction2 implements Actions {

    public final String action;

    public DocksBatchAction2(String action) {
        this.action = action;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Копия Свидетельства о постановке на учёт физического лица в налоговом органе";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupA() {
        ...
        keyboardRow.add(new KeyboardButton("Нет такого документа (перейти к следующему 3/16)"));
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Прикрепить следующий документ 3/16"));
