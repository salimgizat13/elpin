...
public class DocksBatchAction9 implements Actions {

    public final String action;
    public DocksBatchAction9(String actions) {
        this.action = actions;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Копия сведений о состоянии индивидуального лицевого счёта застрахованного лица ";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupA() {
        ...
        keyboardRow.add(new KeyboardButton("Нет такого документа (перейти к следующему 10/16)"));
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Прикрепить следующий документ 10/16"));
