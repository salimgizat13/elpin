...
public class DocksBatchAction8 implements Actions {

    public final String action;
    public DocksBatchAction8(String actions) {
        this.action = actions;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Копия электронной трудовой книжки";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupA() {
        ...
        keyboardRow.add(new KeyboardButton("Нет такого документа (перейти к следующему 9/16)"));
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Прикрепить следующий документ 9/16"));
