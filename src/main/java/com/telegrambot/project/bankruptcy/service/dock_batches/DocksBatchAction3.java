...
public class DocksBatchAction3 implements Actions {

    public final String action;
    public DocksBatchAction3(String actions) {
        this.action = actions;
    }
    ...
    public BotApiMethod handle(Update update) {
        ...
        String text = "Копия паспорта Должника";
    ...
    public static ReplyKeyboardMarkup initReplyMarkupA() {
        ...
        keyboardRow.add(new KeyboardButton("Нет такого документа (перейти к следующему 4/16)"));
    ...
    public static ReplyKeyboardMarkup initReplyMarkupB() {
        ...
        keyboardRow.add(new KeyboardButton("Прикрепить следующий документ 4/16"));
